        ...
        <div className="unit-card">
          ...
          <div className="unit-card">
            ...
            <div className="unit-details">
                ...
                <div className="unit-detail">
                    <span className="label">Ubicación</span>
                    <span className="value">Legando a Tehuacán</span>
                </div>
                <div className="unit-detail">
                    <span className="label">Última salida</span>
                    <span className="value">9:25</span>
                </div>
            </div>
        </div>
          ...
          <div className="unit-card">
            <div className="unit-header">
                <span className="unit-number">ALT-01</span>
                <span className="unit-status en-base">
                    <span className="status-indicator"></span>
                    En base
                </span>
            </div>
            <div className="unit-details">
                ...
                <div className="unit-detail">
                    <span className="label">Ubicación</span>
                    <span className="value">En base</span>
                </div>
                <div className="unit-detail">
                    <span className="label">Última salida</span>
                    <span className="value">9:35</span>
                </div>
            </div>
        </div>
          ...
          <div className="unit-card">
            <div className="unit-header">
                <span className="unit-number">ALT-01</span>
                <span className="unit-status fuera-servicio">
                    <span className="status-indicator"></span>
                    Fuera de servicio
                </span>
            </div>
